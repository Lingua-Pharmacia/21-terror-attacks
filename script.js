...
// PERSISTENCE
let lifetimeScore = parseInt(localStorage.getItem('terrorScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedTerrorLessons')) || [];
...
// STATIONS
const stations = [
    {file:"01_The911Attacks.mp3", title:"The 9/11 Attacks"},
    {file:"02_TheAirIndiaBombing.mp3", title:"Air India Flight 182"},
    {file:"03_TheBaliBombings.mp3", title:"The Bali Bombings"},
    {file:"04_TheBeslanSchoolSiege.mp3", title:"Beslan School Siege"},
    {file:"05_TheEntebbeHijacking.mp3", title:"The Entebbe Hijacking"},
    {file:"06_TheGarissaAttack.mp3", title:"Garissa University Attack"},
    {file:"07_TheGrandMosqueSeizure.mp3", title:"Grand Mosque Seizure"},
    {file:"08_TheJonestownMassacre.mp3", title:"The Jonestown Massacre"},
    {file:"09_TheLockerbieBombing.mp3", title:"The Lockerbie Bombing"},
    {file:"10_TheLondonBombings.mp3", title:"The London 7/7 Bombings"},
    {file:"11_TheMadridBombings.mp3", title:"The Madrid Train Bombings"},
    {file:"12_TheMoscowTheaterSiege.mp3", title:"Moscow Theater Siege"},
    {file:"13_TheMumbaiAttacks.mp3", title:"The Mumbai Attacks"},
    {file:"14_TheMunichMassacre.mp3", title:"Munich Olympics Massacre"},
    {file:"15_TheNairobiBombing.mp3", title:"Nairobi Embassy Bombing"},
    {file:"16_TheNorwayAttacks.mp3", title:"The Norway Attacks"},
    {file:"17_TheOklahomaCityBombing.mp3", title:"Oklahoma City Bombing"},
    {file:"18_TheParisAttacks.mp3", title:"The Paris Attacks"},
    {file:"19_ThePeshawarSchoolMassacre.mp3", title:"Peshawar School Massacre"},
    {file:"20_TheTokyoSubwayAttack.mp3", title:"Tokyo Subway Attack"},
    {file:"21_TheWestgateMallSiege.mp3", title:"Westgate Mall Siege"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('terrorScore', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedTerrorLessons', JSON.stringify(completedLessons));
    }
